...
//读取数据库内容
        ...
        Cursor cursor = MainActivity.db.query(word.w.TABLE_NAME, new String[]{word.w.COLUMN_NAME_WORD, word.w.COLUMN_NAME_V, word.w.COLUMN_NAME_NOTES, word.w.COLUMN_NAME_EXAMPLE},
